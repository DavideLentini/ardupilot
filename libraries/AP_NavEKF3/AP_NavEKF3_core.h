...
private:
    ...
    public:
        ...
        ftype varInnovRng;               // range beacon observation innovation variance (m^2)
        ftype innovRng;                  // range beacon observation innovation (m)
        uint32_t lastTimeRng_ms[4];      // last time we received a range beacon measurement (msec)
